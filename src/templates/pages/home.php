<main class="main-text-medium">
    <div class="home-logo" style="background-image:url(/assets/img/logos/logo_square_512px.png)"></div>
    <h1 class="title-light lato no-highlight center">Atlas for No Man's Sky</h1>
    <p class="text-light center lato-medium" style="margin-bottom: 50px;">Atlas for No Man's Sky is a guide app for No Man's
    ...
    <img alt="app screenshots" class="dash-show only-desktop" src="/assets/img/screens/dash_small_compressed.png" width="80%">
    <div class="grid frontpage">
        <div class="card-mobile">
            <img alt="screenshot" class="card-img-full" src="/assets/img/screens/dash_1_small.png"/>
        </div>
        <div class="text-card">
            <p class="lato-light no-highlight"
               style="font-weight: bold; font-size: calc(100% + 1.5vw); color: #000; margin-bottom: 0;">
                Achievements</p>
            <p class="text-light lato-medium">Keep track of all your achievements.<br>All platforms are supported.</p>
        </div>
        <div class="card-mobile">
        ...
        <div class="text-card">
            ...
            <p class="text-light lato-medium">Stay up to date with all the latest news<br>about No Man's Sky.</p>
        </div>
        <div class="card-mobile">
        ...
        <div class="text-card">
            ...
            <p class="text-light lato-medium">View all important information.<br>From simple stats to detailed descriptions.</p>
        </div>
    </div>
</main>
